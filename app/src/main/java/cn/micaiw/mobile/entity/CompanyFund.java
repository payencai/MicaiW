 ...
 * P2P实体类
 */
public class CompanyFund extends RVBaseCell implements Serializable {
    ...
    public CompanyFund(String name) {
        super(null);
    }
    ...
    public RVBaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_company_rv_fund, parent, false);
    ...
    public void onBindViewHolder(final RVBaseViewHolder holder, int position) {
        ...
        MLog.log("getFundPlatformByType", platformName);
        ...
        //holder.setText(R.id.bidPlan, bidPlan);
        ...
        style.setSpan(new AbsoluteSizeSpan(32), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
